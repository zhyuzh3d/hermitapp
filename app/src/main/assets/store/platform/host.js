(() => {
  ...
  const methods = new Set(["apps.importZip", "backup.export", "support.open", "shell.reload","about.info", "about.openRepository", "agent.resetPassword", "agent.start", "agent.status", "agent.stop", "apps.archive", "apps.confirmDirectory", "apps.enterDev", "apps.exportDev", "apps.favorite", "apps.installOnline", "apps.launch", "apps.leaveDev", "apps.list", "apps.pickDirectory", "apps.pickIcon", "apps.pin", "apps.reinstall", "apps.releases", "apps.remove", "apps.resetDev", "apps.rollback", "apps.scanQr", "apps.setCrossOriginNetwork", "apps.setNotificationEnabled", "apps.setRuntimeMode", "apps.update", "apps.updateFromSource", "apps.updatePresentation", "apps.updateUrls", "backup.restore", "backup.restoreData", "diagnostics.info", "licenses.info", "permissions.list", "permissions.revoke", "shell.updateLocal", "voice.status", "voice.ttsVoices", "voice.configure", "voice.testTts", "voice.openSettings"]);
