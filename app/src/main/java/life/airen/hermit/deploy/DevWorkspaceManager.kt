...
import life.airen.hermit.model.DevWorkspace
...
class DevWorkspaceManager(
    ...
    fun requireDevelopableApp(appId: String): life.airen.hermit.model.WebAppInstance {
    ...
    companion object {
        ...
        private val PROTECTED_HAPP_IDS = setOf("life.airen.hermit", "life.airen.hermitui")
